...
@Component({
    selector: "app-dialog-seleccionar-producto-sorteo",
    templateUrl: './dialog.seleccionar.producto.sorteo.component.html',
    styleUrls: ['./dialog.seleccionar.producto.sorteo.component.scss']
})
export class DialogSeleccionarProductoSorteoComponent implements OnInit {
    title: string;
    description: string;
    option1: string;
    option2: string;
    ...
    constructor(private dialogRef: MdDialogRef<DialogSeleccionarProductoSorteoComponent>) {
    }
